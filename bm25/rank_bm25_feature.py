...
if __name__ == '__main__':
    ...
    MAX_FEAT_LEN = 200
    FEAT_SAVE_PATH = '/root/autodl-tmp/xiaolong/WorkSpace/Amazon-KDDCUP-23/bm25/cache/feat_bm25.pkl'
    ...
    feat_bm25 = BM25Okapi(feat_corpus, corpus_col_name='feat', tokenizer=tokenizer, max_length=MAX_FEAT_LEN, k1=1.5, b=0.75, epsilon=0.25)

    with open(FEAT_SAVE_PATH, 'wb') as f:
        pickle.dump(feat_bm25, f)
        logger.info(f'feat is saved in {FEAT_SAVE_PATH}')
