python ./RecStudio/run.py --model=GRU4Rec_Next_Feat --dataset=kdd_cup_2023_DE --do_encode_query --test_task=task1 \
 --layer_num=2 --dropout_rate=0.5 --use_product_feature=1 --use_text_feat=0 --feat_id_concat=0 --batch_size=1024 \
 ...
 --model_path=/root/autodl-tmp/xiaolong/WorkSpace/Amazon-KDDCUP-23/best_ckpt_phase2/logs/GRU4Rec_Feat_Cat/2023-06-06-18-09-59.ckpt --gpu=4
...
python ./RecStudio/run.py --model=GRU4Rec_Next_Feat --dataset=kdd_cup_2023_JP --do_encode_query --test_task=task1 \
 ...
 --model_path=/root/autodl-tmp/xiaolong/WorkSpace/Amazon-KDDCUP-23/best_ckpt_phase2/logs/GRU4Rec_Feat_Cat/2023-06-07-00-23-41.ckpt --gpu=4
...
python ./RecStudio/run.py --model=GRU4Rec_Next_Feat --dataset=kdd_cup_2023_UK --do_encode_query --test_task=task1 \
 ...
 --model_path=/root/autodl-tmp/xiaolong/WorkSpace/Amazon-KDDCUP-23/best_ckpt_phase2/logs/GRU4Rec_Feat_Cat/2023-06-06-18-10-22.ckpt --gpu=4